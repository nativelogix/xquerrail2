...
<xsl:param name="source" as="xs:string?"/>
  ...
  <xsl:template match="doc:variable">
    <div id="{ concat('var_', replace(doc:name, ':', '_')) }">
      <h4><pre class="prettyprint lang-xq"><u>Variable</u>:&#160;$<xsl:value-of select="doc:name"/> as <xsl:value-of select="(doc:type,'item()*')[1]"/><xsl:value-of select="doc:type/@occurrence"/></pre></h4>
