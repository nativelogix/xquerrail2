...
<div >
  ...
  <div id="export" class="content-box">
     ...
     <div id="export-tabs">
                    ...
                    return
                      if($field/domain:navigation/@exportable eq "true" or 
                       ...
                       <tr>
                         ...
                         <td><input type="text" name="name__{($field/@name)}" value="{($field/@label,$field/@name)[1]}"/></td>
                         <td><input type="text" name="format__{($field/@name)}" value=""/></td>
                         <td><input type="checkbox" name="export__{($field/@name)}" value="true" checked="checked"/></td>                    
                       </tr>
                     else ()
                 }</tbody>
             </table>
          ...
          <div id="export-sort" class="content-box content-box-header">
            <div class="content-box-wrapper">
                <h2>Sorting</h2>
                <div class="export-sorter">
